...
public class report_user extends JFrame implements ActionListener
{
	JLabel heading;
	JPanel jp,jp1,jp2;
	JScrollPane jsp1;
	...
	String head[]={"firstname","lastname","userid","password","secq","seca","contact"};
    ...
    heading=new JLabel("LOGIN REPORT");
